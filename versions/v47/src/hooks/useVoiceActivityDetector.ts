...
/** 开录确认窗：预滚动 PCM 已覆盖判定前音频，可尽量短 */
const defaultSpeechStartDelayMs = 40
/**
 * 静音多久才判定「说完了」并分段发送。
...
export function useVoiceActivityDetector({
  ...
  }, [canStartSpeech, onListeningReady, onRecordingChunk, onRecordingComplete, onSpeechEnd, onSpeechPrime, onSpeechPrimeCancel, onSpeechStart])
