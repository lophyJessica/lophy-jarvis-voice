...
export function useVoiceActivityDetector({
  ...
  const callbacksRef = useRef({ canStartSpeech, onSpeechStart, onSpeechEnd, onRecordingComplete })
  ...
  useEffect(() => {
    callbacksRef.current = { canStartSpeech, onSpeechStart, onSpeechEnd, onRecordingComplete }
  }, [canStartSpeech, onRecordingComplete, onSpeechEnd, onSpeechStart])
