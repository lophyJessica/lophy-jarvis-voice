...
const webmPreviewIntervalMs = 550
const webmPreviewIntervalWithInterimMs = 1_800
const webmPreviewMinBytes = 1_200
const webmPreviewFirstMinBytes = 900
/** 跟嘴专用：录音中定时 webm /asr（百度时代 chunk 有 MID；腾讯 chunk 常空，靠此补跟嘴） */
const livePreviewLoopMs = 420
const livePreviewFirstDelayMs = 480
