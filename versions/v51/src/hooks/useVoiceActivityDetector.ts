...
/** 办公室+键盘：0.036 降低敲键误触发；轻声可调滑块 */
const defaultSilenceThreshold = 0.036
/** 预热 ASR：持续有声 ~280ms，过滤敲键短脉冲 */
const defaultSpeechPrimeDelayMs = 280
/** 开录须晚于 prime */
const defaultSpeechStartDelayMs = 400
/**
 * 静音多久才判定「说完了」并分段发送。
