...
function VoiceConsole({ username, onLogout, isDev }: { username: string; onLogout: () => void; isDev: boolean }) {
  ...
  }, [appendStreamingSpeechText, beginStreamingSpeech, cancelSpeech, endStreamingSpeech, messageApi, pendingDocuments, pendingImages, persistTurn, synthesisSupported, transitionTo, waitForSpeechDrain])
  ...
  const handleComposerSend = useCallback((text: string) => sendMessage(text), [sendMessage])
